...
<table width="100%" border="0" align="center">
  ...
  >
    <td class="col1"><a href="controller?action=detail&goodsid=${goods.id}">${goods.description}</a></td>
    <td class="col2">${goods.price}</td>
    <td class="col3"><a href="controller?action=add&id=${goods.id}&name=${goods.name}&price=${goods.price}&pagename=list">添加到购物车</a></td>
  </tr>
  </c:forEach>
</table>
...
<div class="footer">
  <hr  width="100%" />
  Copyright © xhy 1998 - 2021. All Rights Reserved </div>
</body>
</html>
